...
- 28 tabelas no schema SQLite, migrations 0004 a 0009 aplicadas;
...
| -------------------------- | --------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| Landing e captacao         | avancado                    | landing com contato e demo persistidos, rate limit dedicado, payload fechado, honeypot e consentimento LGPD registrado com versao de politica | texto da politica de privacidade, links legais reais e workflow de lead |
...
| Clientes                   | concluida                   | CRUD, importacao com dry-run e deduplicacao, exportacao, busca e paginacao server-side, consentimento de marketing                            | —                                                                       |
| Produtos                   | concluida                   | CRUD, importacao com dry-run e deduplicacao, exportacao, paginacao e filtros server-side, precos em centavos                                  | —                                                                       |
...
| Notificacoes               | infraestrutura pronta       | adapters fail-closed sem PII em log, entrega registrada por destinatario, estado de leitura por usuario                                       | providers e preferencias por canal                                      |
...
| Busca/notificacoes globais | concluida                   | busca global tenant-scoped com wildcard escapado e limite; notificacoes por usuario com estado de leitura clicavel e acao de marcar todas     | preferencias de notificacao por canal                                   |
