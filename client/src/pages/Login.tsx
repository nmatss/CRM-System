    ...
    <div className="min-h-screen bg-[#050A1A] text-white relative overflow-hidden">
      ...
      <div className="min-h-screen flex items-center justify-center px-4 py-20 sm:py-24">
        ...
        >
          ...
          <Card
            className="relative bg-[#0F172A]/80 backdrop-blur-xl border-white/10 shadow-2xl"
            ...
            <CardContent className="px-4 sm:px-6 pb-6">
              <form onSubmit={handleLogin} className="space-y-4 sm:space-y-5">
                <div className="space-y-2">
                  <Label htmlFor="login-username" className="text-gray-300 text-sm sm:text-base">
                    CPF ou Email
                  </Label>
                ...
                <div className="space-y-2">
                  <Label htmlFor="login-password" className="text-gray-300 text-sm sm:text-base">
                    Senha
                  </Label>
                  <div className="relative">
      ...
      <Dialog open={showPasswordModal} onOpenChange={handlePasswordModalClose}>
        <DialogContent
          className="w-[calc(100%-2rem)] max-w-sm sm:max-w-md bg-[#0F172A] border-white/10 text-white"
        ...
        >
          <DialogHeader className="px-1">
            ...
            <DialogTitle className="text-lg sm:text-xl text-center text-white">
              Alterar Senha
            </DialogTitle>
          ...
          <form onSubmit={handlePasswordChange} className="space-y-4 mt-2 sm:mt-4">
            <div className="space-y-2">
              <Label htmlFor="current-password" className="text-gray-300 text-sm sm:text-base">
                Senha Atual
              </Label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 sm:h-5 sm:w-5 text-gray-500" />
            ...
            <div className="space-y-2">
              <Label htmlFor="new-password" className="text-gray-300 text-sm sm:text-base">
                Nova Senha
              </Label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 sm:h-5 sm:w-5 text-gray-500" />
            ...
            <div className="space-y-2">
              <Label htmlFor="confirm-password" className="text-gray-300 text-sm sm:text-base">
